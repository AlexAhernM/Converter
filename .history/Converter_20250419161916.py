...
# Frame 1
frame1 = tk.Frame(ventana_principal, bg="dodger blue")
...
boton_seleccionar_archivo_kml = tk.Button(frame1, text="Seleccionar archivo", command=seleccionar_archivo_kml)
boton_seleccionar_archivo_kml.place(relx=0.4, rely=0.15, relwidth=0.13, relheight=0.15)

boton_transformar_archivo = tk.Button(frame1, text="Transformar archivo", command=procesar_archivo, state=tk.DISABLED)
boton_transformar_archivo.place(relx=0.20, rely=0.55, relwidth=0.13, relheight=0.15)

# Crear checkbutton elevacion
obtener_elevacion = tk.BooleanVar() # Crear variable de estado de checkbox
checkbox_obtener_elevacion = tk.Checkbutton(frame1, text="Obtener elevación", variable=obtener_elevacion, command=mostrar_advertencia)
checkbox_obtener_elevacion.place(relx=0.22, rely=0.35, relwidth=0.12, relheight=0.1)

# Colocar etiqueta elevacion  en la ventana principal
etiqueta_advertencia = tk.Label(frame1, wraplength=400, bg= "dodger blue")
etiqueta_advertencia.place(relx=0.30, rely=0.50, relwidth=0.80, relheight=0.15)
