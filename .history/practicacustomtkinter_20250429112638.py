...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.selectfile_frame = customtkinter.CTkFrame(self, width=600)
        ...
        self.selectfile_frame.grid_rowconfigure(2, weight=1)
        ...
        self.boton_lookmap.grid(row=2, column=1, padx=10, pady=10, sticky ='nswe')
