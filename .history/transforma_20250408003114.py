...
class Mapa:
    def __init__(self, lat_centro, lon_centro, zoom_start):
        self.mapa = folium.Map(location=[lat_centro, lon_centro], zoom_start=zoom_start)  
    ...
    def guardar_mapa(self):
        ...
        self.mapa.save(os.path.join(downloads_folder,'mapa.html'))
        return downloads_folder

    def abrir_mapa(self, downloads_folder):
        webbrowser.open(os.path.join(downloads_folder,'mapa.html'))
