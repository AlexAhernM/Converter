...
from transforma import parseo, root, convierte, agregar_polilinea, obtener_elevacion_valor, crear_dxf
import threading
...
def procesar_archivo():
    ...
    if ruta_archivo_kml:
        ...
        coords, coords_dec, lat_centro, lon_centro, zoom_start, radio = parseo(entrada_archivo_kml, obtener_elevacion)
        
        actualizar_imagen_mapa(lat_centro, lon_centro, zoom_start, radio)
        
        doc, coords, layers, coords_dec = convierte(root, ruta_archivo_kml, obtener_elevacion_valor)
        agregar_polilinea(doc, coords, layers)
