...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.rbuttomkml.grid(row=0, column=0, padx=10, pady=(40,20),  sticky='w')
        ...
        self.boton_generate_files = customtkinter.CTkButton(self.intermedio_frame, text='generate conversion', command=lambda: generate_files(self))
        self.boton_generate_files.grid(row=2, column=0, padx=(20,0) pady=(10,0), sticky='w')
