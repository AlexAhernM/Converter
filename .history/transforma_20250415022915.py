...
def procesar_multigeometrias(coord, geoms,  layer_name,  obtener_elevacion_valor,coords, layers, coords_dec):
    for geom in geoms:
...
def convierte(root,  obtener_elevacion_valor):
    ...
    for pm in root.findall('.//{http://www.opengis.net/kml/2.2}Placemark'):
        ...
        if ls is not None:
            ...
            utm_points, coords, coords_dec, layers= procesar_multigeometrias(coord, mg,  layer_name,  obtener_elevacion_valor,coords, layers, coords_dec)
