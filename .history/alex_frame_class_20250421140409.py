...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.checkbox_frame1 = MyCheckboxFrame(self, values=[{'text':'DXF (CAD)'   , 'text_color':'white', 'font':('Times New Roman',12)},
                                                            {'text':'Shapefile'   , 'text_color':'black'},
                                                            {"text":"xlxs (Excel)", 'text_color': 'Yellow'}, 
                                                            {'text':'csav -txt'   , 'text_color':'RoyalBlue1'}
                                                            ])
        self.checkbox_frame2 = MyCheckboxFrame(self, values=[{'text':'KML to..', 'text_color':'white'},
