...
from transforma import parseo, convierte,  get_zoom_level, crear_dxf
import threading
...
def procesar_archivo():
    ...
    if ruta_archivo_kml:
        ...
        doc,  _, _, coords, coords_dec, layers, lat_centro,lon_centro, radio= convierte (ruta_archivo_kml, root,  obtener_elevacion_valor)
