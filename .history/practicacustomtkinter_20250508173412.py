...
class CheckboxFrame(customtkinter.CTkFrame):
    def __init__(self, master, values, enabled=True, width=650, height = 280):
...
class App(customtkinter.CTk):
    ...
    def __init__(self):
        ...
        # ROW 0 - SELECT FRAME
        self.selectfile_frame = customtkinter.CTkFrame(self, width=650, height=280, corner_radius=6)
