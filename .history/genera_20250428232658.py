...
def crear_dxf(self, doc, ruta_archivo_kml, coords, layers, coords_dec):
    ...
    msg_dxf = "No se ha seleccionado opcion de convertir kml a dxf"
    msg_shp = "No se ha seleccionado opcion de convertir kml a Shapefile"
    msg_xlx = "No se ha seleccionado opcion de convertir kml a Excel"
    ...
    if dxf_selected or shp_selected:
        ...
        if dxf_selected:
            ...
            msg_dxf= f"Archivo DXF guardado correctamente en {ruta_archivo_salida_dxf}"
            temp_file = False
        ...
        if shp_selected:
            ...
            with fiona.open(ruta_archivo_salida_dxf, 'r', driver='DXF') as src:
                ...
                msg_shp = f"Archivo SHP guardado correctamente en {ruta_archivo_salida_shp}"
    ...
    if xlsx_selected:
        ...
        msg_xlx =  f"Archivo Excel guardado correctamente en {ruta_archivo_salida}"
