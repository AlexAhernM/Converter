...
class App(customtkinter.CTk):
    ...
    def show_image_in_preview(self):
        ...
        images_config = [
            ...
            {"url": "https://raw.githubusercontent.com/AlexAhernM/Converter/master/earthcity.png", "size": (520, 180)},
        ...
        self.preview_label2.grid(row=0, column=0, padx=10, pady=10, sticky='nsew')
