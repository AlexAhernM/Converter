...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.grid_columnconfigure(0, weight=1) # La primera columna ocupará 3 partes del ancho
        ...
        self.checkbox_frame = customtkinter.CTkFrame(self, width=700)
        self.checkbox_frame.grid(row=0, column=1, padx=10,pady =10)
