...
def actualizar_imagen_mapa(lat_centro, lon_centro, zoom_start, radio):
    ...
    mapa_tkinter.pack(fill=tk.BOTH, expand=True)
    mapa_tkinter.grid(row=0, column=0)
...
def procesar_archivo():
    _, _, _, lat_centro, lon_centro, zoom_start, _ = parseo(entrada_archivo_kml, obtener_elevacion)
