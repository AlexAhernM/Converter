...
def confirmar_localizacion(self, doc, ruta_archivo_kml, coords, layers, coords_dec):
    ...
    boton_looks_good = customtkinter.CTkBaseClass(self.approval_frame, text="Looks good", command=lambda: respuesta_confirmacion("correcta"),
                                                  fg_color='gray69', text_color='Blue' ,  corner_radius=6)
                                 
    boton_looks_good.grid(row =0, column=1, padx =10, pady =10, sticky ="e")
    
    boton_no_good = customtkinter.CTkButton(self.approval_frame, text="Localización incorrecta", command=lambda: respuesta_confirmacion("incorrecta"),
                              fg_color='gray69', text_color='Blue' ,  corner_radius=6)
