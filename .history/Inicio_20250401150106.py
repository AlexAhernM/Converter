...
def seleccionar_archivo_kml(entrada_archivo_kml):
...
def mostrar_advertencia(obtener_elevacion):
    ...
    if obtener_elevacion.get():
        print ("Advertencia: El proceso de transformación puede ser más demorado debido a la obtención de elevación.")
    else:
        print ("ahora chupa este cogotito")

def mostrar_mensaje(voy_a_la_luna):
...
def carga_programa():
    ...
    ventana_principal.title("Convertir archivos KLM")
    ...
    boton_seleccionar_archivo_kml = tk.Button(ventana_principal, text="Seleccionar archivo", command=seleccionar_archivo_kml(entrada_archivo_kml))

    # Crear el botón para transformar el archivo
    boton_transformar_archivo = tk.Button(ventana_principal, text="Transformar archivo",
                                        command= parseo(entrada_archivo_kml, obtener_elevacion))
    ...
    checkbox_obtener_elevacion = tk.Checkbutton(ventana_principal, text="Obtener elevación", variable=obtener_elevacion,
                                                command=mostrar_advertencia(obtener_elevacion))
    ...
    checkbutton_voy_a_la_luna = tk.Checkbutton(ventana_principal, text="Voy a la luna", variable=voy_a_la_luna, command=mostrar_mensaje(voy_a_la_luna))
