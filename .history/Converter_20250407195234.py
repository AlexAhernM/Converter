...
def mostrar_advertencia():
    ...
    if obtener_elevacion.get():
        etiqueta_advertencia.config(text="Advertencia: Debe estar conectado a internet,  debido al proceso on-iine para la btención de elevación, lo que toma mast tiempo")
    else:
