...
app.checkbox_frame = customtkinter.CTkFrame(app, fg_color='gray69', corner_radius=16)
app.checkbox_frame.grid(row=0, column=0, padx=10, pady = 10, sticky = 'nsw')

app.checkbox_1 = customtkinter.CTkCheckBox(app, text="DXF (CAD)", text_color='white')
