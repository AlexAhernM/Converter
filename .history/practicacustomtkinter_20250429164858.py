...
class CheckboxFrame(customtkinter.CTkFrame):
    def __init__(self, master, values, enabled=True, width=600):
...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.selectfile_frame = customtkinter.CTkFrame(self, width=600, height=160)
        ...
        self.checkbox_type.grid(row=0, column=1, padx=(50,10), pady =10, sticky='nsw')
...
def show_messages(self, messages):
    ...
    if msg_dxf:
        self.save_dxf = customtkinter.CTkLabel(self.checkbox_type, text=msg_dxf)
        self.save_dxf.grid(row=0, column=1, padx=5, pady=(25,5), sticky='we')

    if msg_shp:
        self.save_shp = customtkinter.CTkLabel(self.checkbox_type, text=msg_shp)
        self.save_shp.grid(row=1, column=1, padx=5, pady=5, sticky='we')
        
    if msg_xlx:
        self.save_xlx = customtkinter.CTkLabel(self.checkbox_type, text=msg_xlx)
        self.save_xlx.grid(row=2, column=1, padx=5, pady=5, sticky='we')
