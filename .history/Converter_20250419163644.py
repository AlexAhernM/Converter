...
# Frame 1
frame1 = tk.Frame(ventana_principal, bg="gray 99")
...
boton_seleccionar_archivo_kml = tk.Button(frame1, text="Seleccionar archivo KML", bg='gray 99', command=seleccionar_archivo_kml)
...
etiqueta_advertencia = tk.Label(frame1, wraplength=400, bg= "gray 99", fg='white')
