...
class Mapa:
    def __init__(self, lat_centro, lon_centro, zoom_start):
        self.mapa = folium.Map(location=[lat_centro, lon_centro], zoom_start=zoom_start, title='Mapa')

    def agregar_datos(self, lat_centro, lon_centro, radio):
        folium.Circle([lat_centro, lon_centro], radius=radio, color='blue', tooltip='Área de interés').add_to(self.mapa)

    def guardar_mapa(self):
        downloads_folder = os.path.join(os.path.expanduser('~'), 'Downloads')
        archivo = os.path.join(downloads_folder, 'mapa.html')
        self.mapa.save(archivo)
        return archivo

    def abrir_mapa(self):
        archivo = os.path.join(os.path.expanduser('~'), 'Downloads', 'mapa.html')
