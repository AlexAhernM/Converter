...
class MyCheckboxFrame(customtkinter.CTkFrame):
    ...
    def __init__(self, master, values, font=('Times New Roman', 14)):
        super().__init__(master, fg_color='gray69', corner_radius=16)
        self.values = values
        self.checkboxes = []

        self.titulo = customtkinter.CTkLabel(self, text=self.title, fg_color="gray30", corner_radius=6)
        ...
        for i, valores in enumerate(self.values):
            ...
            checkbox.grid(row=i, column=0, padx=10, pady=(18, 0), sticky="ew")
