...
boton_seleccionar_archivo_kml.pack(side=tk.LEFT, padx=5, pady=5)



#Colocar los elementos en la ventana principal
etiqueta_archivo_kml.pack(side=tk.LEFT, padx=5, pady=5)
entrada_archivo_kml.pack(side=tk.LEFT, padx=5, pady=5)
...
checkbox_obtener_elevacion.pack(padx=5, pady=5)
