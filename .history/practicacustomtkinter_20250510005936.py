...
def show_image_in_preview(self):
    ...
    if image1 and image2:
        self.preview_image = customtkinter.CTkImage(light_image=image1, dark_image=image1, size=(200, 130))
        self.preview_image2 = customtkinter.CTkImage(light_image=image2, dark_image=image2, size=(200, 100))

        self.preview_frame.grid_columnconfigure(0, weight=0)
        self.preview_frame.grid_columnconfigure(1, weight=1)
        self.preview_frame.grid_rowconfigure(0, weight=1)
        self.preview_frame.grid_propagate(True)
    ...
    # Crear y mostrar los CTkLabel
        if not hasattr(self, 'preview_label'):
            ...
            self.preview_label.grid(row=0, column=1, padx=(10,10), pady=(10,10), sticky='nsew')
        ...
        if not hasattr(self, 'preview_label2'):
            ...
            self.preview_label2.grid(row=0, column=0, padx=(10,10), pady=(10,10), sticky='w')
    else:
