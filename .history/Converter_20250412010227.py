...
from transforma import parseo,  agregar_polilinea, crear_dxf
import threading
...
def procesar_archivo():
    ...
    if ruta_archivo_kml:
        ...
        coords, coords_dec, lat_centro, lon_centro, zoom_start, radio, doc, layers, layer_name=parseo(entrada_archivo_kml, obtener_elevacion)
