...
class MyCheckboxFrame(customtkinter.CTkFrame):
    def __init__(self, master):
        super().__init__(master, fg_color='gray69')
...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.button = customtkinter.CTkButton(self, text="my button", command=self.button_callback, fg_color='pink', corner_radius=6)
