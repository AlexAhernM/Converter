...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.checkbox_frame = customtkinter.CTkFrame(self, border_width=1, border_color='white' width=850)
        self.checkbox_frame.grid(row=0, column=1, padx=10, pady=10, sticky ='e')
        
        self.preview_frame = customtkinter.CTkFrame(self)
        self.preview_frame.grid(row = 1, column = 1, padx=10, pady=10, columnspan ='3', sticky = 'nsew')
