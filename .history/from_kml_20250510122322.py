...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        # FRAME: ROW 0 - INTERMEDIO SIN USO POR EL MOMENTO
        ...
        self.tipo_geo.set("KML")
        self.tipo_geo.set("Coordenadas")
        
        self.rbuttomkml = customtkinter.CTkRadioButton(self.intermedio_frame, text="KML", variable=self.tipo_geo, value="KML")
        self.rbuttomkml.grid(row=0, column=0, padx=10, pady=10, sticky='ew')
        
        self.rbuttomcord = customtkinter.CTkRadioButton(self.intermedio_frame, text="Coordenadas", variable=self.tipo_geo, value="Coordenadas")
        self.rbuttomcord.grid(row=1, column=0, padx=10, pady=10, sticky='ew')
