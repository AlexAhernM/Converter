...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.selectfile_frame = customtkinter.CTkFrame(self, width=1800)
        self.selectfile_frame.grid(row=0, column = 0, padx=10, pady=10, sticky ='nse')
        ...
        self.frame_save_label = customtkinter.CTkFrame(self, width=900)
