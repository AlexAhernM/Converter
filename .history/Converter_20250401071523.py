...
# Ubicar  checkbox en la ventana principal
checkbox_obtener_elevacion.grid(row=1, column=1, padx=5, pady=5)

# Configurar checkbox
checkbox_obtener_elevacion.config(command=mostrar_advertencia)
# Crear la etiqueta para mostrar el mensaje
etiqueta_advertencia = tk.Label(ventana_principal, text="", wraplength=400)

# Colocar la etiqueta en la ventana principal
