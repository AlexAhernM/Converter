...
boton_seleccionar_archivo_kml.place(relx=0.02, rely=0.15, relwidth=0.13, relheight=0.15)

boton_transformar_archivo = tk.Button(frame1, text="CONVERTIR", command=procesar_archivo, state=tk.DISABLED)
