...
def parseo(contenido_kml_uniforme, obtener_elevacion):
    obtener_elevacion_valor = obtener_elevacion.get()
    
    try:
        tree = ET.parse(contenido_kml_uniforme)
        root = ET.fromstring(contenido_kml_uniforme)
    ...
    resultado = convierte(root, contenido_kml_uniforme, obtener_elevacion_valor)
