...
def show_image_in_preview(self):
    ...
    if image1 and image2:
        self.preview_image = customtkinter.CTkImage(light_image=image1, dark_image=image1, size=(400, 230))
    ...
    # Crear y mostrar los CTkLabel
        if not hasattr(self, 'preview_label'):
            ...
            self.preview_label.grid(row=0, column=0, padx=(10,10), pady=(10,10), sticky='nsew')
        ...
        if not hasattr(self, 'preview_label2'):
            ...
            self.preview_label2.grid(row=0, column=1, padx=(10,10), pady=(10,10), sticky='nsew')
    else:
