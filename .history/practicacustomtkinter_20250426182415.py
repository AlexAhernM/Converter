...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.selectfile_frame.grid(row=0, column = 0, padx=10, pady=0, sticky='w')
        ...
        self.preview_frame.grid(row = 2, column = 0, padx=10, pady=0,  rowspan =2, columnspan ='2', sticky = 'nsew')
