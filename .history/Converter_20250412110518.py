...
from transforma import parseo, uniformar_estilo,  crear_dxf
import threading
...
def procesar_archivo():
    ...
    if ruta_archivo_kml:
        ...
        coords, coords_dec, lat_centro, lon_centro, zoom_start, radio, doc, layers=parseo(archivo_uniforme_kml, obtener_elevacion)
        actualizar_imagen_mapa(lat_centro, lon_centro, zoom_start, radio)
        crear_dxf(doc, archivo_uniforme_kml, coords, layers, coords_dec)
