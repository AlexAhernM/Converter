...
def mostrar_advertencia():
    if obtener_elevacion.get():
        ...
        etiqueta_advertencia.config(text="ahora chupame la pichula")

# Crear variable de estado de checkbox
obtener_elevacion = tk.BooleanVar()

# Crear checkbox
checkbox_obtener_elevacion = ttk.Checkbutton(ventana_principal, text="Obtener elevación", variable=obtener_elevacion, 
