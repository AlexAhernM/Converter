...
class App(ctk.CTk):
    def __init__(self):
        ...
        self.frame_utm.grid(row=0, column=3, padx=10, pady=10, sticky ='w')
        ...
        self.kml_dec_radio.grid(row=2, column = 0, padx=10, pady=10, sticky='w')
        ...
        self.crear_button.grid(row=3, column=0, padx=10, pady=10, sticky ='ew', columnspan = 2)
