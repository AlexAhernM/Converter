...
class MyCheckboxFrame(customtkinter.CTkFrame):
    ...
    def __init__(self, maestro, titulo,  values,  font=('Times New Roman', 14)):
        super().__init__(maestro, fg_color='gray69', corner_radius=16)
...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.checkbox_frame2 = MyCheckboxFrame(self, '',  values=[{'text':'KML to..', 'text_color':'gray29'},
        ...
        self.button = customtkinter.CTkButton(self, text="my button", command=self.button_callback,fg_color='pink', text_color='white')
