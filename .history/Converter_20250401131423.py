...
def mostrar_advertencia():
    ...
    print("Valor de obtener_elevacion:", voy_a_la_luna.get())
...
checkbutton_voy_a_la_luna = tk.Checkbutton(ventana_principal, text="Voy a la luna", variable=voy_a_la_luna, command=mostrar_advertencia)
checkbutton_voy_a_la_luna.grid (row=6, column=1, padx=5, pady=5)
...
etiqueta_mensaje.grid (row=8, column=1, padx=5, pady=5)
