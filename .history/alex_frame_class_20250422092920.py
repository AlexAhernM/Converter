...
class MyCheckboxFrame(customtkinter.CTkFrame):
    ...
    def __init__(self, master, titulo,  values, texto,  font=('Times New Roman', 14)):
        ...
        self.button  = customtkinter.CTkButton(self, texto)
...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.checkbox_frame1 = MyCheckboxFrame(self, 'Formatos', 'texto',  values=[{'text':'DXF (CAD)'   , 'text_color':'white'},
