...
def obtener_altitud_desde_kml(entrada_archivo_kml):
    ...
    print("Ruta del archivo KML:", ruta_archivo_kml)  # Mensaje de depuración
    
    try:
        
        kml = simplekml.Kml(open(ruta_archivo_kml, 'r').read())
    
        
        print("Archivo KML abierto correctamente")  # Mensaje de depuración
        ...
        print("Puntos obtenidos correctamente")  # Mensaje de depuración
        ...
        etiqueta_resultados.config(text=f"Error: {str(e)}")
