...
etiqueta_archivo_kml = tk.Label(frame1, text="Ruta del archivo KML:", font=("Times New Roman Baltic", 12), bg="dodger blue", fg="white")
...
boton_seleccionar_archivo_kml = tk.Button(frame1, text="Seleccionar archivo", font=('Comic Sans MS',12))
