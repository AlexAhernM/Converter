...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.selectfile_frame.grid(row=0, column = 0, padx=10, pady=10, sticky='nswe')
        ...
        self.frame_save_label.grid (row=0, column=1, padx=(50,0), pady=10, sticky= 'nsw')
        ...
        self.checkbox_type.grid(row=0, column=2, padx=(550,10), pady =10, sticky='nse')
