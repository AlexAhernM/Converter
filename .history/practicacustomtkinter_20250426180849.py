...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.label_frame.grid(row=1, column =0, padx=10,pady = (10,0), columnspan = '2', sticky= 'ew')
        
        self.preview_frame = customtkinter.CTkFrame(self)
        self.preview_frame.grid(row = 2, column = 0, padx=10, pady=(600,10), rowspan =2, columnspan ='2', sticky = 'nsew')
