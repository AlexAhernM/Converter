...
def show_image_in_preview(self):
    ...
    self.preview_image = customtkinter.CTkImage(light_image=image, dark_image=image, size=(700, 400))  # Ajusta el tamaño aquí
    ...
    if not self.preview_label:
        ...
        self.preview_label.grid(row=0, column=0, padx=(500,100), pady=10, sticky='nsew')
