...
etiqueta_archivo_kml = tk.Label(frame1, text="Ruta del archivo KML:" ,font=("Arial", 12))
etiqueta_archivo_kml.place(relx=0.01, rely=0.1, relwidth=0.12, relheight=0.09)
