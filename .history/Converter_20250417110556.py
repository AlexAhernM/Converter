...
def generar_conversion():
    ...
    boton_generar = tk.Button(ventana_formatos, text="Generar archivos", command=generar_archivos)
    boton_generar.pack()
