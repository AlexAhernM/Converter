...
import time
from transforma import parseo, lat_centro, lon_centro, ruta_archivo_kml
import threading
import folium
#from folium.plugins import KML
from folium.plugins import KMLOverlay
...
# Agregar el archivo KML al mapa
#folium.plugins.KML(ruta_archivo_kml).add_to(mapa)
KMLOverlay(ruta_archivo_kml).add_to(mapa)
