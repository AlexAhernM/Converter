...
boton_transformar_archivo.pack(padx=5, pady=5)
...
etiqueta_archivo_kml = tk.Label(frame1, text="Ruta del archivo KML:")
etiqueta_archivo_kml.place(relx=0.01, rely=0.1, anchor=tk.NW)

entrada_archivo_kml = tk.Entry(frame1, width=50)
entrada_archivo_kml.place(relx=0.2, rely=0.1, anchor=tk.NW)
...
boton_seleccionar_archivo_kml.place(relx=0.7, rely=0.1, anchor=tk.NW)
...
checkbox_obtener_elevacion.place(relx=0.01, rely=0.5, anchor=tk.NW)

# Colocar etiqueta elevacion  en la ventana principal
etiqueta_advertencia = tk.Label(frame1, wraplength=400)
etiqueta_advertencia.pack(padx=5, pady=5)
