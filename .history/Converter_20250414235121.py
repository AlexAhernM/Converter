...
from transforma import parseo, convierte, agregar_polilinea,  obtener_coordenadas, obtener_maximos_minimos, get_zoom_level,  crear_dxf
import threading
...
def procesar_archivo():
    ...
    if ruta_archivo_kml:
        ...
        lat_centro, lon_centro, zoom_start, radio, doc, root, obtener_elevacion_valor=parseo(ruta_archivo_kml, obtener_elevacion)
        doc,  coord,  layer_name, utm_points, coords, coords_dec, layers = convierte (root,  obtener_elevacion_valor)
        coords, layers, coords_dec = obtener_coordenadas(coord, layer_name,  obtener_elevacion_valor)
