...
tipo_coordenadas_var = customtkinter.StringVar()
tipo_coordenadas_var.set("decimales")
...
kml_dec_radio  = customtkinter.CTkRadioButton(app, text="Coordenadas decimales", variable=tipo_coordenadas_var, value="decimales", command=seleccionar_tipo_coordenadas)
kml_dec_radio.grid(row=1, column = 0, padx=10, pady=10, sticky='w')

kml_utm_radio = customtkinter.CTkRadioButton(app, text="Coordenadas UTM", variable=tipo_coordenadas_var, value="utm", command=seleccionar_tipo_coordenadas)
