...
def actualizar_imagen_mapa(lat_centro, lon_centro, zoom_start, root, obtener_elevacion_valor,):
    ...
    for placemark in placemarks:
        ...
        if len(coords_dec) == 1:  # Point
            ...
            mapa_tkinter.set_marker(coords_dec[0][0], coords_dec[0][1], text=layer_name, font=("Times New Roman", 6, "bold"), text_color="blue", marker_color_circle="gray44", marker_size=6)
