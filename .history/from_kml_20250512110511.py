...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.boton_generate_files = customtkinter.CTkButton(self.intermedio_frame, text='Convert File', command=lambda: generate_conv(self))
        self.boton_generate_files.grid(row=2, column=0, padx=(65,0), pady=(44,0), sticky='w')
...
def generate_conv(self):
    ...
    if self.tipo_geo.get() == "KML":
        ...
        #self.boton_generate_files.configure(command=lambda: generate_files(self))
        self.boton_generate_files.configure(state= 'normal')
