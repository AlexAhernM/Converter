...
class App(customtkinter.CTk):
    ...
    def __init__(self):
        ...
        self.preview_frame = customtkinter.CTkFrame(self, height=500, width=500, fg_color='midnightblue4')
...
def show_image_in_preview(self):
    ...
    self.preview_image = customtkinter.CTkImage(light_image=image, dark_image=image, size=(870, 530))  # Ajusta el tamaño aquí
    ...
    if not self.preview_label:
        ...
        self.preview_label.grid(row=0, column=0, padx=(340,100), pady=(0,10), sticky='nsew')
