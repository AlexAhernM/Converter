...
def actualizar_imagen_mapa(lat_centro, lon_centro, zoom_start, radio):
    ...
    mapa_tkinter = TkinterMapView(frame_mapa, width=800, height=400)
    mapa_tkinter.set_position(lat_centro, lon_centro)
    mapa_tkinter.set_zoom(zoom_start)
    # Agregar el círculo al mapa de TkinterMapView
    mapa_tkinter.set_polygon([(lat_centro + radio/111, lon_centro), (lat_centro, lon_centro + radio/111), 
                              (lat_centro - radio/111, lon_centro), (lat_centro, lon_centro - radio/111)], 
