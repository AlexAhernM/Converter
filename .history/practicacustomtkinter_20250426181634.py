...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.preview_frame.grid(row = 1, column = 0, padx=10, pady=10, rowspan =2, columnspan ='2', sticky = 'nsew')
        
        
        self.label_frame = customtkinter.CTkFrame(self)
        self.label_frame.grid(row=2, column =0, padx=10,pady = 0, columnspan = '2', sticky= 'ew')
