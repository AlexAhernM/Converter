...
class App(customtkinter):
    def __init__(self):
        ...
        self.checkbox_frame_1.grid(row=0, column=1, padx=(550,10), pady =10, sticky='nsw')
        ...
        self.label_frame.grid(row=1, column =0, padx=10,pady = 0, sticky= 'ew', columnspan=2)
        ...
        self.checkbox_frame_2.grid(row =1, column = 1, padx=10, pady=5)
...
def update_preview(self, lat_centro, lon_centro, zoom_start, root, altitud_value):
    ...
    self.mapa_tkinter.grid(row=1, column=0, padx=10, pady=(500,0), sticky='nsew', columnspan=2)    
