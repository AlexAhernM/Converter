...
app.checkbox_2 = customtkinter.CTkCheckBox(checkbox_frame, text="Shapefile", text_color='RoyalBlue1')
app.checkbox_2.grid(row=1, column=0, padx=10, pady=(10, 0), sticky="w")

app.checkbox_3 = customtkinter.CTkCheckBox(checkbox_frame, text="xlxs - Excel", text_color='green3')
