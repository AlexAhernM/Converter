...
from transforma import parseo, convierte, agregar_polilinea, obtener_elevacion_valor, crear_dxf
import threading
...
def procesar_archivo():
    ...
    if ruta_archivo_kml:
        root, coords, coords_dec, lat_centro, lon_centro, zoom_start, radio, doc, layers = parseo(entrada_archivo_kml, obtener_elevacion)
        resultado2 = convierte(root, ruta_archivo_kml, obtener_elevacion_valor)
