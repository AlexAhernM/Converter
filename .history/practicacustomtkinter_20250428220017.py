...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.save_labels = customtkinter.CTkFrame(self)
        self.save_labels.grid (row=0, column=1, padx=10, pady=10, sticky= 'nsw')
...
def confirmar_localizacion(self, doc, ruta_archivo_kml, coords, layers, coords_dec):
    def respuesta_confirmacion(respuesta):
        if respuesta == "incorrecta":
            ...
            msg_dxf, msg_shp, msg_xlx = generate_files(self, doc, ruta_archivo_kml, coords, layers, coords_dec)
