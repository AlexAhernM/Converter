...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.inputdata = customtkinter.CTkEntry(self.inputdata_frame,placeholder_text="CTkEntry",
                               ...
                               border_width=2,
                               corner_radius=6) 
        self.inputdata.grid(row =0, column=1, padx=10, pady=10, columnspan=2, sticky='ew' )
        self.inputdata_frame.columnconfigure(1, weight=1)
        ...
        self.button = customtkinter.CTkButton(self.inputdata_frame, text="Visualizar", command=self.button_callback, width=200, height=30)
        self.button.grid(row=3, column=1, padx=10, pady=10, sticky="ew")
