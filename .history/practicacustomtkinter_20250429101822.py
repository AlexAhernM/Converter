...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.checkbox_type = CheckboxFrame(self ,values=['DXF (CAD)', 'Shapefile', 'xlxs (Excel)'], enabled=False, width=300)
        self.checkbox_type.grid(row=0, column=2, padx=(10,10), pady =10, sticky='nsw')
