...
class App(customtkinter.CTk):
    ...
    def __init__(self):
        ...
        if self.__class__.imagen_tk is None:
            # Descargar la imagen y asignarla a imagen_tk
        ...
        # Utilizar imagen_tk para crear el label
        self.label_imagen = customtkinter.CTkLabel(self.preview_frame, image=self.__class__.imagen_tk, text="")
        self.label_imagen.image = self.__class__.imagen_tk
