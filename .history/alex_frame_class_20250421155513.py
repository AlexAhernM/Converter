...
class MyCheckboxFrame(customtkinter.CTkFrame):
    ...
    def __init__(self, master, titulo,  values, font=('Times New Roman', 14)):
        ...
        self.titulo.grid(row=0, column=0, padx=50, pady=(10, 10), sticky="ew", columnspan=2)
        
        for i, valores in enumerate(self.values):
            if 'font' not in valores:
                valores['font'] = font
            checkbox = customtkinter.CTkCheckBox(self, **valores)
            checkbox.grid(row=i+1, column=0, padx=10, pady=(18, 0), sticky="ew")
...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.checkbox_frame2 = MyCheckboxFrame(self, 'Opciones', values=[{'text':'KML to..', 'text_color':'white'},
                                                             {'text':'Lat/Lon to KML','text_color':'RoyalBlue2'}])
        
        self.checkbox_frame1.grid(row=0, column=0, padx=10, pady=(10, 0), sticky="nsew")
        self.checkbox_frame2.grid(row=0, column=1, padx=10, pady=(10, 0), sticky= 'nse')
        ...
        self.button.grid(row=3, column=0, padx=1, pady=10, sticky="ew", columnspan=2)
