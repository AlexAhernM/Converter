...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.selectfile_frame = customtkinter.CTkFrame(self, width=600, height=180)
        ...
        self.checkbox_type.grid(row=0, column=1, padx= 10, pady =5, sticky='nsw')
...
def show_messages(self, messages):
    ...
    if msg_shp:
        self.save_shp = customtkinter.CTkLabel(self.checkbox_type, text=msg_shp,columnspan =2 )
        self.save_shp.grid(row=1, column=1, padx=5, pady=5, sticky='w')
        
    if msg_xlx:
        self.save_xlx = customtkinter.CTkLabel(self.checkbox_type, text=msg_xlx, columnspan =2)
