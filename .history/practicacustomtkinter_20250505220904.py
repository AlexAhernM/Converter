...
class App(customtkinter.CTk):
    ...
    def show_image_in_preview(self):
        # URL cruda de la imagen desde el repositorio de GitHub
        ...
        self.preview_image = customtkinter.CTkImage(light_image=image, dark_image=image, size=(300, 300))  # Ajusta el tamaño aquí
