            ...
            if outer_boundary is not None:
                ...
                if linear_ring is not None:
                    coord = linear_ring.find('{http://www.opengis.net/kml/2.2}coordinates')
                     ...
                     # funcion crea listas con las coordenadas y capas  de la geometria
                    if coord is not None:
                        ...
                        for point in points:
                            ...
                            names.append(layer_name)   # Lista de Capas
                            layers.append(layer_name)  # Lista de Capas
                            coords_dec.append((lat, lon)) # Lista de Coordenadas decinamales
