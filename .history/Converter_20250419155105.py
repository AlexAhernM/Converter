...
boton_seleccionar_archivo_kml = tk.Button(frame1, text="Seleccionar archivo", font=('Times New Roman',12), command=seleccionar_archivo_kml)
...
boton_transformar_archivo.place(relx=0.4, rely=0.20, relwidth=0.13, relheight=0.15)
...
etiqueta_advertencia = tk.Label(frame1, wraplength=400)
