...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.selectfile_frame = customtkinter.CTkFrame(self, width=800)
        ...
        self.selectdata_entry = customtkinter.CTkEntry(self.selectfile_frame, width=390, height=25, corner_radius=6 )
