...
class App(customtkinter.CTk):
    ...
    def show_image_in_preview(self):
        ...
        images_config = [
            ...
            {"url": "https://raw.githubusercontent.com/AlexAhernM/Converter/master/earthcity.png", "size": (300, 180)},
        ...
        self.preview_label1.grid(row=0, column=0, padx=(150, 0), pady=(0, 10), sticky='nsew')
        
        self.preview_label2 = customtkinter.CTkLabel(self.selectfile_frame, text="", image=self.preview_images[1], fg_color='#bed7f5')
