...
MyCheckboxFrame.button = customtkinter.CTkButton(MyCheckboxFrame, text="my button", command=MyCheckboxFrame.button_callback, fg_color='pink', corner_radius=6, text_color='black')
MyCheckboxFrame.button.grid(row=3, column=0, padx=10, pady=10, sticky="ew")
