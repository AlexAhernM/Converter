...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.label_mappreview = customtkinter.CTkLabel(self.preview_frame, text='Vision Preliminar Area Geografica a Procesar', 
                                                       fg_color='gray39', text_color='Blue' , width = 290, height=25, corner_radius=6)
        self.label_mappreview.grid(row=0, column =0, padx= (100,10), pady= (5,900))
...
def update_preview(self, lat_centro, lon_centro, zoom_start, root, altitud_value):
    ...
    mapa_tkinter.grid(row=1, column=0, padx=10, pady=10, sticky='nsew', columnspan=2)
