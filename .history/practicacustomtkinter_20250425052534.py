...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.selectdata_boton = customtkinter.CTkButton(self.selectfile_frame, text='Select File', command=select_file(self))
...
def button_preview(self):
    ...
    if ruta_archivo_kml:
        ...
        root, obtener_elevacion_valor = parseo(ruta_archivo_kml, self.get_altitude)
