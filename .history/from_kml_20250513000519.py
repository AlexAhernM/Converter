...
class App(customtkinter.CTk):
    ...
    def show_image_in_preview(self):
        ...
        images_config = [
            ...
            {"url": "https://raw.githubusercontent.com/AlexAhernM/Converter/master/earthcity.png","size": (400, 180)},
            {"url": "https://raw.githubusercontent.com/AlexAhernM/Converter/master/osm.png", "size": (400, 180)}
        ]
        ...
        for config in images_config:
            ...
            if response.status_code == 200:
                ...
                preview_image = customtkinter.CTkImage(light_image=image, dark_image=image)
        ...
        self.preview_label1 = customtkinter.CTkLabel(self.preview_frame, text="", image=self.preview_image[0])
