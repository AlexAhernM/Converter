...
def show_messages(self, messages):
    ...
    if msg_shp:
        self.save_shp = customtkinter.CTkLabel(self.checkbox_type, text=msg_shp,columnspan =2, text_color='RoyalBlue1' )
        self.save_shp.grid(row=1, column=1, padx=5, pady=5, sticky='w')
        
    if msg_xlx:
        self.save_xlx = customtkinter.CTkLabel(self.checkbox_type, text=msg_xlx, columnspan =2, text_color='green2')
